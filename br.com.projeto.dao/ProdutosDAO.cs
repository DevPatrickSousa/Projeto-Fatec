    ...
    public class ProdutosDAO
    {
        ...
        public void CadastrarProduto(Produtos produto)
        {
            try
            {
                ...
                string sql = @"insert into tb_produtos (descricao, preco, qtd_estoque, for_id,img_produto)
                                 values (@descricao, @preco, @qtd_estoque, @for_id,@img_produto)";
                ...
                executasql.Parameters.AddWithValue("@img_produto", produto.img_produto);

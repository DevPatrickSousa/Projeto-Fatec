...
namespace Projeto_Vendas_Fatec_2.br.com.projeto.view
{
    public partial class Frmprodutos : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            openFileDialogx.InitialDirectory = @"C:\";
            openFileDialogx.Filter = "Images (*.BMP;*.JPG;*.GIF,*.PNG,*.TIFF)|*.BMP;*.JPG;*.GIF;*.PNG;*.TIFF|" + "All files (*.*)|*.*";
            openFileDialogx.InitialDirectory = @"C:\Users\Patrick\Pictures";
            openFileDialogx.RestoreDirectory = true;
            openFileDialogx.ReadOnlyChecked = true;
            openFileDialogx.ShowReadOnly = true;

            DialogResult result = openFileDialogx.ShowDialog();

            if (result == System.Windows.Forms.DialogResult.OK)
            {
                // Le os arquivos selecionados 
                foreach (String arquivo in openFileDialogx.FileNames)
                {
